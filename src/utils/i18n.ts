...
const englishMessages = {
  ...
  'commands.sync.options.preset': 'Built-in preset: claude, github, cursor, kiro, or all',
  ...
  'commands.export.options.preset': 'Export preset: cursor, claude, github, windsurf, cline, aider, codex, kiro, or all',
...
const portugueseMessages: TranslationDictionary = {
  ...
  'commands.sync.options.preset': 'Preset padrão: claude, github, cursor, kiro ou all',
  ...
  'commands.export.options.preset': 'Preset de exportação: cursor, claude, github, windsurf, cline, aider, codex, kiro ou all',
